    ...
    <section className="relative w-full border-b border-zinc-100 bg-white overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10 py-8 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          {/* Left Column: Learning Propositions (Restored Content) */}
          <div className="col-span-1 lg:col-span-5 flex flex-col items-start text-left">
            ...
            <h1 className="max-w-4xl text-5xl md:text-6xl font-normal tracking-tight text-zinc-900 leading-[1.05]">
              Your{" "}
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <Link
                href="/get-started"
                className="flex h-11 items-center justify-center gap-2 bg-blue-600 px-10 text-[14px] text-white font-medium transition-all hover:bg-blue-700 active:scale-[0.98] rounded-none shadow-lg shadow-blue-500/10"
              >
                Get started free
              ...
              <Link
                href="/courses"
                className="flex h-11 items-center justify-center border border-zinc-200 bg-white px-10 text-[14px] text-zinc-900 font-medium transition-all hover:border-zinc-800 active:scale-[0.98] rounded-none advocacy-node"
              >
                Explore courses
              </Link>
            </div>
          ...
          {/* Right Column: Visual Component (High presence) */}
