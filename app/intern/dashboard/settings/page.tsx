            ...
            <form onSubmit={handleSubmit} className="space-y-12 max-w-2xl">
                ...
                <section className="space-y-6">
                   <div className="flex items-center gap-2 pb-2 border-b border-zinc-100">
                        ...
                        <h2 className="text-[11px] font-bold uppercase tracking-widest text-zinc-400">Profile Image</h2>
                    </div>
                ...
                <section className="space-y-6 text-left">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                           ...
                           <div className="space-y-1.5">
                              <label className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Study Year</label>
                              <select 
                                 required
                                 value={formData.year}
                        ...
                        <div className="space-y-1.5">
                           <label className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Interested Area (Bounties)</label>
                           <select 
                              required
