    ...
    return (
        <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-6 font-sans">
            ...
            >
                ...
                <button 
                    type="button"
                    className="w-full h-11 border border-zinc-200 flex items-center justify-center gap-3 text-sm font-medium text-zinc-600 hover:bg-zinc-50 transition-all mb-6 bg-white"
                >
                ...
                <form onSubmit={handleSignIn} className="space-y-5">
                    ...
                    <button
                        disabled={loading}
                        type="submit"
                        className="w-full h-11 bg-zinc-900 text-white text-xs font-bold uppercase tracking-widest hover:bg-black transition-all mt-2 active:scale-[0.98]"
                    >
