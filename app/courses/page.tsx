    ...
    return (
        <div className="min-h-screen bg-white text-zinc-900 font-sans selection:bg-blue-100">
            ...
            <main className="w-full">
                ...
                {/* 2. Page Header - Skill Grid Style - Compact & Normal Weight */}
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-10 py-16 md:py-24">
                    {loading ? (
                        <div className="flex h-96 flex-col items-center justify-center gap-4">
                            <Loader2 className="h-6 w-6 animate-spin text-blue-600" strokeWidth={1.5} />
                            <p className="text-[13px] text-zinc-400 font-medium">Synchronizing curriculum...</p>
                        </div>
                    ) : (
