...
<head>
    ...
    <style>
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.5; color: #1a1a1a; margin: 0; padding: 0; background-color: #f8f9fa; }
        .wrapper { padding: 20px 10px; }
        .container { width: 100% !important; max-width: 600px; margin: 0 auto; background: #ffffff; border: 1px solid #eeeeee; padding: 0px; border-radius: 0px; overflow: hidden; }
        .header { background-color: #FACC15; padding: 20px 30px; text-align: left; }
        .content { padding: 35px 30px; }
        h1 { font-size: 19px; font-weight: 800; margin: 0 0 12px; color: #000; letter-spacing: -0.02em; line-height: 1.2; }
...
<body>
    <div class="wrapper">
        <div class="container">
            <div class="header">
                <img src="https://ik.imagekit.io/dypkhqxip/sflogo?updatedAt=1774952380858" alt="Student Forge" height="36" />
            </div>
            <div class="content">
                <h1>${title}</h1>
                <p>${content}</p>
            ...
            <div class="footer">
                ...
                <div class="footer-text">Student Forge Technologies Pvt. Ltd.</div>
                <div style="margin-top: 10px; opacity: 0.5; font-weight: 500; font-size: 9px;">&copy; 2026 Student Forge. All rights reserved.</div>
            </div>
        </div>
    </div>
</body>
