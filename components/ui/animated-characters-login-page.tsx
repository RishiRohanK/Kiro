  ...
  return (
    <div className="min-h-screen bg-zinc-50 flex flex-col justify-between selection:bg-blue-100">
      ...
      <div className="flex-1 flex items-center justify-center p-4 md:p-8">
        {/* Sign In Card Container (Reduced height to 515px) */}
        <div className="w-full max-w-[960px] md:h-[515px] bg-background border border-zinc-200 flex flex-col md:flex-row overflow-hidden rounded-lg shadow-sm">
          {/* Left Content Section (Charcoal Grey Panel with pb-0) */}
          <div className="relative hidden md:flex md:w-[45%] flex-col justify-end bg-gradient-to-br from-zinc-700 via-zinc-800 to-zinc-900 pt-6 px-6 pb-0 text-white rounded-none">
            <div className="relative z-20 flex items-end justify-center h-[340px] overflow-hidden">
              {/* Cartoon Characters (Scaled down to fit within the reduced 515px container) */}
          ...
          {/* Right Login Section */}
          <div className="w-full md:w-[55%] flex flex-col justify-center items-center py-5 px-6 md:pt-14 md:pb-5 bg-background rounded-none">
